...
const Material = ({ item, className }: MaterialProps) => {
  return (
    ...
    >
      <div className="ring-theme-gray-3  hover:bg-theme-50 text-theme-content-2/80 ring-gray-blue-100 hover:ring-theme-400 group flex w-full flex-col  items-center justify-center rounded-md px-2  py-2 ring-1 transition hover:ring-2">
