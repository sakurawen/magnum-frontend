...
const Element = (props: ElementProps) => {
  ...
  return (
    ...
    >
      <div className="ring-theme-400 pointer-events-none relative select-none ring-inset">
        <div
          className={cx(
            'select-ring bg-theme-50/5 absolute z-10 h-full w-full ring-2 ring-inset',
